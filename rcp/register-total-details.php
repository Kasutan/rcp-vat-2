...
<table class="rcp_registration_total_details rcp-table test">
	...
	<tfoot>
		...
		<tr class="rcp-total-no-tax">
			<th scope="row"><?php _e( 'Total', 'rcp' ); ?></th>
			<td data-th="<?php esc_attr_e( 'Total', 'rcp' ); ?>" id="rcp-vat-total-no-tax"><?php rcp_registration_total(); ?></td>
		</tr>

		<tr class="rcp-vat">
			<th scope="row"><?php _e( 'Total VAT', 'rcp' ); ?></th>
			<td data-th="<?php esc_attr_e( 'Total VAT', 'rcp' ); ?>" id="rcp-vat-amount"></td>
		</tr>

		<tr class="rcp-total-tax-inc">
			<th scope="row"><?php _e( 'Total Today Tax inc.', 'rcp' ); ?></th>
			<td data-th="<?php esc_attr_e( 'Total Today  Tax inc.', 'rcp' ); ?>" data-value="<?php echo rcp_get_registration_total();?>" id="rcp-vat-total"><?php rcp_registration_total(); ?></td>
		</tr>
		...
		<?php if ( rcp_registration_is_recurring() ) : ?>
			...
			<tr class="rcp-recurring-total">
				...
				<td data-th="<?php echo esc_attr( $label ); ?>" id="rcp-vat-recurring-total-no-tax"><?php rcp_registration_recurring_total(); ?></td>
			</tr>
		<?php endif; ?>
